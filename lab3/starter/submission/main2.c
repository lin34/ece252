...
void *producer(void *arguments)
{
    ...
    while (produced <= 50 - args->num)
    {
        ...
        sprintf(url, "http://localhost:2530/image?img=%d&part=%d", args->image_num, produced);
...
int main(int argc, char **argv)
{
    ...
    curl_global_init(CULR_GLOBAL_DEFAULT);
